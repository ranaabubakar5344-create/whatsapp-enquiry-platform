...
function getProgrammesMessage(
  ...
  return [
    ...
    "",
    "BSc (Hons) Computer Science",
    "https://uca.feuc.ae/programmes/computer-science/",
    "",
    "BSc (Hons) Games Development",
    "https://uca.feuc.ae/programmes/game-development/",
    "",
    "BA (Hons) Graphic Design",
    "https://uca.feuc.ae/programmes/graphic-design/",
    "",
    "BA (Hons) Business & Management",
    "https://uca.feuc.ae/programmes/business-management/",
    "",
    "BA (Hons) Visual Communication",
    "https://uca.feuc.ae/programmes/visual-communication/",
    "",
    "BA (Hons) Digital Marketing & Social Media",
    "https://uca.feuc.ae/programmes/digitalmarketing-socialmedia/",
    "",
    "Postgraduate Programme",
    "",
    "MBA",
    "https://uca.feuc.ae/programmes/mba/",
    "",
    "Entry Routes",
    "",
    "Integrated Foundation Year",
    "https://uca.feuc.ae/programmes/integrated-foundation/",
    "",
    "Integrated Pre-Masters",
    "https://uca.feuc.ae/programmes/integrated-premasters/",
    "",
...
function getFeesMessage(
  ...
  if (language === "ar") {
    return [
      ...
      "",
      "عرض البرامج:",
      "https://uca.feuc.ae/Programmes-ucauae/",
    ].join("\n");
  }
